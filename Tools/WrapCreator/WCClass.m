...
- (void) outputWrappers
{
  ...
  [selectorMapOutput appendString: @"      { objC name, java name, java argument types, ready, class method or not }\n\n"];
  ...
  [selectorMapOutput appendString: @"      The ready flag is 'NO' if the java argument signature is ready\n"];
  ...
  [selectorMapOutput appendString: @"      which is what 'ready'==YES means.  Beware: ready==NO is much\n"];
