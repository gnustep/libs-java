...
- (void) outputWrappers
{
  ...
  if (initializers != nil)
      ...
      for (i = 0; i < count; i++)
	{
	  ...
	  declaration = [self declarationOfMethod: [initializers objectAtIndex: i]
			    isClassMethod: NO];
  ...
  if (classMethods != nil)
      ...
      for (i = 0; i < count; i++)
	{
	  ...
	  declaration = [self declarationOfMethod: [classMethods objectAtIndex: i]
			    isClassMethod: YES];
	  method = [WCMethod newWithObjcMethodDeclaration: declaration
			     class: self
			     isConstructor: NO];
  ...
  if (instanceMethods != nil)
      ...
      for (i = 0; i < count; i++)
	{
	  ...
	  declaration = [self declarationOfMethod: [instanceMethods objectAtIndex: i]
			    isClassMethod: NO];
	  method = [WCMethod newWithObjcMethodDeclaration: declaration
			     class: self
			     isConstructor: NO];
