...
@implementation WCUnsignedLongLongType 
...
- (id) initWithObjcType: (NSString *)aType
{
  ...
  NSLog (@"Warning: `unsigned long long' is too big for java");
  NSLog (@"I map it to the Java `long' type; but if you use huge values, it won't work");
