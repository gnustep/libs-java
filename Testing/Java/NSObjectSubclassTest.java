/* NSObjectSubclassTest: test of subclassing gnu.gnustep.base.NSObject in java
...
class NSObjectSubclassTest extends NSObject 
{
  String name;

  public NSObjectSubclassTest ()
  {
    super ();
  }

  public NSObjectSubclassTest (String aName)
  {
    super ();
    name = aName;
  }
  ...
  public String toString ()
  {
    ...
    output += "(subclass with name " + name + ")";
    return output;
  }
  ...
  public static void main (String[] args) 
    throws Throwable
  {
    NSObjectSubclassTest objectOne;
    NSObject objectTwo;
    
    /* Create two NSObject */
    objectOne = new NSObjectSubclassTest ();
    objectTwo = new NSObject ();
    
    /* Describe them */
    System.out.println ("Created an NSObject and an NSObject subclass:");
    ...
    objectOne = null;
    objectOne = new NSObjectSubclassTest ("Nicola");
    ...
    System.out.println ("Now trying to set and get name from object one");
    System.out.println ("* its name is now: " + objectOne.getName ());
    objectOne.setName ("Marco");
    System.out.println ("* after setting it to 'Marco' is: " + objectOne.getName ());
    System.out.println ("");

    /* Happy end */
    if (objectOne.getName ().equals ("Marco") == false)
